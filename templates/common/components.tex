...
% #1 : (string) Signature text 
% ex: - Signature et/ou cachet de l'organisme précédé de la mention "Bon pour accord" :
%     - Signature du demandeur de remboursement précédée de la mention "Lu et approuvé" :
\newcommand{\PayementInfoSignature}[1]{
...
\newcommand{\DetailedTableElement}[6]{
    #1 & #2 & #3 & #4 & #5 & #6 ~\euro{} & #6 ~\euro{} \\[2pt]
}
